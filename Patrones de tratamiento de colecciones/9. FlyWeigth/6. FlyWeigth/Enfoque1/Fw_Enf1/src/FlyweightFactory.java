...
public class FlyweightFactory {
  ...
  private class Flyweight implements FlyweightIntr {
    ...
    private Flyweight(String division) {
      ...
      //for simplicity
      if (division.equals("North")) {setValues("CMP","addr1", "cty1","st1","10000");
      }
      if (division.equals("South")) {setValues("CMP","addr2", "cty2","st2","20000");
      }
      if (division.equals("East")) {setValues("CMP","addr3", "cty3","st3","30000");
      }
      if (division.equals("West")) {setValues("CMP","addr4", "cty4","st4","40000");
      }
    }
